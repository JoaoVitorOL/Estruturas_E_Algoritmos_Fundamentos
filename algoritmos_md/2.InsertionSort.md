...
> Se o valor a ser organizado for menor que o anterior, os elementos da esquerda são deslocados uma posição a direita, dando espaço ao novo valor.
...
![GIF Animado](https://en.wikipedia.org/wiki/Insertion_sort#/media/File:Insertion-sort-example-300px.gif)
