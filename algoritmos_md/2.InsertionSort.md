...
> O algoritmo mantém uma parte do vetor sempre ordenada|marcada
> e insere cada novo elemento na posição correta dessa parte ordenada.
> Dessa forma, não é necessário percorrer o array inteiro mais de uma vez como no Bubble sort.
